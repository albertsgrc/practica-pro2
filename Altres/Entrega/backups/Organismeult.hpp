...
class Organisme {
	...
	private:
         ...
         */
        static void llegir_arbcelula(Arbcel&a, int&idmax);
         ...
         *       val 0</li></ul>
         */
        static void retallar_arbcelula(Arbcel&a, int&idmax);
         ...
         */
        static void estirar_arbcelula(Arbcel&a, int&idmax);
         ...
         *       </ul>
         */
        static void crear_fill(Arbcel&x1, Arbcel&x2, Arbcel&fill, int&idclonsx2, int&idmaxf, int&tamint, int&tamx1, int&tamx2);
         ...
         *       cèl·lules plantades al \p fill</li></ul>
         */
        static void aux_clons_x1(Arbcel&x1, Arbcel&fill, int&tamx1, int&idmaxf);
         ...
         */
        static void aux_clons_x2(Arbcel&x2, Arbcel&fill, int&tamx2, int&idmaxf, int&idclonsx2);
};
