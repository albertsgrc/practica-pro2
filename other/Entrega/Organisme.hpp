...
class Organisme {
	...
	private:
         ...
         * \pre \p a és buit
         * \post \p a és l'arbre de cèl·lules llegit pel canal estàndard
         *       d'entrada en format <b>preordre</b>, \p idmax conté
         *       l'identificador de màxim valor de totes les cèl·lules d'\p a
         */
        static void llegir_acel(Acel&a, int&idmax);
         ...
         *       </li></ul>
         */
        static void escriure_acel(Acel&a);
         ...
         *       val 0</li></ul>
         */
        static void retallar_acel(Acel&a, int&idmax);
         ...
         *       de totes les cèl·lules d'\p a</li></ul>
         */
        static void estirar_acel(Acel&a, int&idmax);
         ...
         * @param[out] stams Paràmetre de sortida on es guardarà el valor de
         *       la suma de tamanys dels arbres \p x1 i \p x2
         * \pre <ul><li>\p x1 i \p x2 són no buits</li><li>\p fill és buit</li>
         *      <li>\p idmaxf = \p tamint = \p tamx1 = \p tamx2 = 0</li>
         ...
         *       \p x2</li><li>\p stams conté la suma dels tamanys dels
         *       arbres \p x1 i \p x2 (nombre de nodes)</li> </ul>
         */
        static void crear_fill(Acel&x1, Acel&x2, Acel&fill, int&idclonsx2, int&idmaxf, int&tamint, int&stams);
         ...
         *        clonificades
         * @param[in,out] tam Nombre de nodes tractats dels arbres dels
         *       organismes que s'estàn reproduint
         ...
         * \pre <ul><li>\p x1 és no buit</li><li>\p fill és buit</li>
         *      <li>\p fill=FILL</li></ul>
         * \post <ul><li>\p x1 no s'ha modificat</li><li>\p tam s'ha
         *       incrementat en el nombre de clons que s'hagin plantat</li>
         *       <li>\p fill és el resultat d'afegir a FILL els clons de les
         *       cèl·lules actives d'\p x1 a més del mínim nombre de cèl·lules
         *       passives per tal que les actives no quedéssin desconectades,
         *       amb identificadors coincidents amb les corresponents cèl·lules
         *       d'\p x1</li><li>\p idmaxf s'ha actualitzat amb el màxim entre
         *       el seu valor inicial i el màxim d'entre tots els identificadors
         *       de les cèl·lules plantades al \p fill</li></ul>
         */
        static void aux_clons_x1(Acel&x1, Acel&fill, int&tam, int&idmaxf);
         ...
         *        clonifiquen
         * @param[in,out] fill Subarbre del fill on es col·loquen les cèl·lules
         *        clonificades
         * @param[in,out] tam Nombre de nodes tractats dels arbres dels
         *       organismes que s'estàn reproduint
         * @param[in,out] idmaxf Identificador màxim de totes les cèl·lules
         ...
         *      <li>fill=FILL</li></ul>
         * \post <ul><li>\p x2 no s'ha modificat</li><li>\p tam s'ha
         *       incrementat en el nombre de clons que s'hagin plantat</li>
         *       <li>\p fill és el resultat d'afegir a FILL els clons de les
         *       cèl·lules actives d'\p x2 a més del mínim nombre de cèl·lules
         *       passives per tal que les actives no quedéssin desconectades,
         *       amb identificadors assignats correlativament en preordre a
         *       partir del valor següent a \p idclonsx2</li><li>\p idclonsx2
         *       conté l'indentificador de l'últim clon plantat, si no se n'ha
         *       plantat cap el seu valor no s'ha modificat</li></ul>
         */
        static void aux_clons_x2(Acel&x2, Acel&fill, int&tam, int&idmaxf, int&idclonsx2);
};
